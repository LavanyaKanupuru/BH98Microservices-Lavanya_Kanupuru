...
public class Employee {
	...
	private String designation; public Employee(int id, String name, double salary, double commision, String designation) {
	super();
	this.id = id;
	this.name = name;
	this.salary = salary;
	...
	public static void main(String[] args) { Employee emp1 = new Employee(101, "lavanya", 50000, 2000, "Manager");
	Employee emp2 = new Employee(102, "likitha", 20000, 1000, "Lead");
	Employee emp3 = new Employee(103, "Ramya", 30000, 1500, "Associate"); 
